...
<body>
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-5 mb-4">สินค้าขายดี</h1>
                        </div>
                        <p class="mb-4 pb-2">ซูชิหน้าปลาเเซวม่อน เบิร์นซอสมายองเนส</p>
    ...
    <div class="container-fluid p-3 pb-5">
        <div class="owl-carousel-item position-relative">
            <center> <img class="img-fluid" src="{{ asset('frontend/img/picture store/Store 1.jpg') }}" width="510px" border="4" align="center">
                <img class="img-fluid" src="{{ asset('frontend/img/picture store/Store 2.jpg') }}" width="260px" border="4" align="center">
                <img class="img-fluid" src="{{ asset('frontend/img/picture store/Store 3.png') }}" width="555px" border="4" align="center">
            </center>
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 text-center">
