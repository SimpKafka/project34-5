                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="review-tab-pro-inner">
                                    <ul id="myTab3" class="tab-review-design">
                                        <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Product Update</a></li>
                                    </ul>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input type="text" class="form-control" name="name" value="{{ $product->name }}" placeholder="Product Title">
                                                            @error('name')
                                                            {{ $errors->first('name') }}
                                                            @enderror
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input type="number" class="form-control" name="price" value="{{ $product->price }}" placeholder="Regular Price">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="text-center custom-pro-edt-ds">
                                                        <input type="submit" value="Update" class="btn btn-ctl-bt waves-effect waves-light">
