                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="{{ route('pro.create') }}">Add Promotion</a>
                            </div>
                            <table>
                                <tr>
                                    <th>
                                ...
                                @foreach($promotion as $keys => $promotion)
                                    <tr>
                                        <td>{{ $keys+1 }}</td>
                                        <td>{{ $promotion->promotion_id }}</td>
                                        <td>{{ $promotion->name }}</td>
                                        <td>{{ number_format($promotion->price) }}</td>
                                        <td>

                                        </td>
                                        <td>
                                            <a href="{{ route('promotion.edit', $promotion->promotion_id) }}"><button type="submit" class="btn btn-warning">Edit</button>></a>
                                            <a href="{{ route('promotion.delete', $promotion->promotion_id) }}"><button type="submit" class="btn btn-danger">Delete</button>></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
